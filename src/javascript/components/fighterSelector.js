...
export async function getFighterInfo(fighterId) {
    ...
    if (!fighterInfo) {
        fighterInfo = await fightersService.getFighterDetails(fighterId);
...
function renderSelectedFighters(selectedFighters) {
    ...
    const firstPreview = createFighterPreview(playerOne, 'left', getFighterInfo);
    const secondPreview = createFighterPreview(playerTwo, 'right', getFighterInfo);
